...
public class HymnsDao {
    ...
    public Cursor getByFirstLineOrderBy(HymnGroup hymnGroup, String filter, String orderBy) {
        ...
        if(orderBy==null) {
         ...
         String sql = "select * from(" +
                    "select first_stanza_line as stanza_chorus, no, _id, hymn_group from hymns where stanza_chorus NOT NULL and stanza_chorus != '' and hymn_group != 'E'" + groupClause + " \n" +
                    "union\n" +
                    "select first_chorus_line as stanza_chorus, no, _id, hymn_group from hymns where stanza_chorus NOT NULL and stanza_chorus != '' and hymn_group != 'E'" + groupClause +
                    ") " + likeClause + orderBy;
    ...
    public Cursor getByLyricText(HymnGroup hymnGroup, String filter) {
        ...
        String sql = "select s.* from hymns h join stanza s on h._id = s.parent_hymn WHERE " + buildLikeClause("text", filter) + " " + "and hymn_group != 'E'" + groupClause + " \n" +
    ...
    public Cursor getByHymnNo(HymnGroup hymnGroup, String filter) {
        ...
        String sql =
                "select first_stanza_line as stanza_chorus, no, _id, hymn_group from hymns where stanza_chorus NOT NULL and stanza_chorus != '' and hymn_group != 'E' "
                        + groupClause + " \n"
                        + likeClause
    ...
    public Cursor getByAuthorsOrComposers(String filter) {
        ...
        String sql = "select * from(" +
                "select author as author_composer, no, _id, hymn_group, first_stanza_line, first_chorus_line from hymns where author_composer NOT NULL and author_composer != '' and hymn_group != 'E' " + groupClause + " \n" +
                "union\n" +
                "select composer as author_composer,  no, _id, hymn_group, first_stanza_line, first_chorus_line from hymns where author_composer NOT NULL and author_composer != '' and hymn_group != 'E' " + groupClause +
                ") " + likeClause + orderBy ;
    ...
    public Cursor getByCategory(HymnGroup hymnGroup, String filter) {
      ...
      //if (hymnGroup == null) hymnGroup = HymnGroup.ML;
        if (hymnGroup == null) hymnGroup = HymnGroup.TA;
        ...
        String sql = "select main_category, sub_category, no, _id, hymn_group, first_stanza_line from hymns where hymn_group != 'E' and main_category NOT NULL" + groupClause + likeClause;
