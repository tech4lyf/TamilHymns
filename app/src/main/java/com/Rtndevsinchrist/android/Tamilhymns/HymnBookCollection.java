...
import com.Rtndevsinchrist.android.Tamilhymns.content.PlayButton;
...
import com.Rtndevsinchrist.android.Tamilhymns.utils.HymnStack;

import java.util.ArrayList;
import java.util.HashMap;

import static com.Rtndevsinchrist.android.Tamilhymns.content.ContentArea.HISTORY_LOGBOOK_FILE;
...
public class HymnBookCollection implements OnLyricVisibleListener {
    ...
    private HymnStack hymnStack = new HymnStack("TA1");
    ...
    public void refresh() {
        ...
        if(getCurrentHymnId()==null) {
            ...
            currentHymnId = records.length>0 ? records[0].getHymnId() : "TA1";
        } else {
